...
- $\beta_0$: Is the y-intercept. The predicted value of y when x is at origin (0).
- $\beta_1$: Is the regression coefficient. The amount of change in predicted in y for increases/decreases in x
- $x$: The independent variable or _feature_ set
